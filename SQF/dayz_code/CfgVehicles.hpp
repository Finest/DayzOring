class CfgVehicles {
	...
	class HMMWV_Ambulance_DZ: HMMWV_Ambulance_DES_EP1
	{
		scope = 2;
		side = 2;
		crew = "";
	...
	class ch47_DZ: kyo_Bravo_November
	{
		displayName = "Ch47";
		scope = 2;
		side = 2;
...
*/
	...
	*/
	// DayZ Oring
		...
		class KPFS_BW_Officer_vestc_UN;
	class Camo1_DZ: KPFS_BW_Officer_vestc_UN {
		displayName = "Survivor";
		side = 1;
		weapons[] = {"Throw","Put"};
		backpack = "";
	...
	class gsc_eco_stalker_head_fred;
	class Bandit1_DZ : gsc_eco_stalker_head_fred {
		displayName = "$STR_CHAR_2";
		side = 1;
		weapons[] = {"Throw","Put"};
		//model = "\dayz\characters\man_bandit";
	...
	class KPFS_GSG9_Soldier_new;
	class Hero1_DZ : KPFS_GSG9_Soldier_new {
		displayName = "Hero Skin";
		side = 1;
		weapons[] = {"Throw","Put"};
		magazines[] = {};
		backpack = "";
	...
	class KPFS_BW_Soldier_hat_UN;
	class BW1_DZ : KPFS_BW_Soldier_hat_UN {
		displayName = "GerSoldier";
		side = TWest;
		weapons[] = {"Throw", "Put"};
		magazines[] = {};
		respawnWeapons[] = {"Throw", "Put"};
	...
	class police1_DZ : KPFS_Policeman_vest_des_cap {
	...
	class police2_DZ : KPFS_Policeman_vest_des_beret {
