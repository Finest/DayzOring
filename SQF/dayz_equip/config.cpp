// config.bin - 01:01:54 01/20/13, generated in 0.17 seconds
...
class CfgVehicles {
	...
	class GuerillaCacheBox;
	
	class TentStorage : GuerillaCacheBox {
		vehicleClass = "Survival";
		displayName = "StorageBox";
