...
class CfgPatches {
	class dayz_code {
		...
		weapons[] = {};
		requiredVersion = 0.1;
		requiredAddons[] = {"KPFS_german_police_E","KPFS_Weapons","KPFS_german_police_vest_des","KPFS_BW_UNOSOM","gsc_units_stalker_patch","sah_civilian_patch","d3z_shotguns","C1987_G3","GLT_Objects","dayz_equip","dayz_weapons","CAMisc3","CABuildingParts","CABuildingParts_Signs","CAStructuresHouse","CAStructuresLand_Ind_Stack_Big","CAStructures_Misc_Powerlines","CAStructures","CABuildings","CABuildings2","Ind_MalyKomin","CAStructures_A_CraneCon","CAStructures_Mil","CAStructures_Nav","CAStructures_Rail","A_Crane_02","A_TVTower","CAStructures_Railway","CAStructuresHouse","CAStructuresHouse_HouseBT"};
	};
...
class CfgSurvival {
	class Inventory {
		class Default {
			//weapons[] = {"Makarov"};
			magazines[] = {"ItemBandage","ItemPainkiller","ItemWaterbottle"};
			weapons[] = {"ItemCompass","ItemFlashlight"};
			backpackWeapon = "";
			backpack = "CZ_VestPouch_EP1";
		};
	};
	class Meat {
		class Default {
...
class CfgBuildingLoot {
	...
	class Residential: Default {
		...
		itemType[] =	{
			...
			{"skin_police1_DZ","magazine"},
			{"skin_police2_DZ","magazine"},
			{"KPFS_P88","weapon"},
			{"Skin_Civilian2_DZ","magazine"},
			{"Skin_Civilian3_DZ","magazine"},
			{"Skin_Civilian4_DZ","magazine"},
			{"Skin_Civilian5_DZ","magazine"}
		};
		itemChance[] =	{
			0.01,
			0.15,
	...
	class Church: Residential {
		...
		// BUNKER start
		class Land_Bet_RGB_667_com_b : Military {
		maxRoaming = 3;
		lootChance = 0.5
		lootPos[] = {{-0.5,-0.1992,-1.81428},{1.08008,0.300781,-1.81428}};
		};
		
		class Land_Bet_RGB_667_plant_r : Military {
		maxRoaming = 0;
		lootChance = 0.9
		lootPos[] = {{-0.5,-0.1992,-1.81428},{1.08008,0.300781,-1.81428}};
		};
		
		class Land_Bet_RGB_667_plant_b : Military {
		maxRoaming = 3;
		lootChance = 0.5
		lootPos[] = {{-0.5,-0.1992,-1.81428},{1.08008,0.300781,-1.81428}};
		};
		
		class Land_Bet_RGB_667_r : Military {
		maxRoaming = 3;
		lootChance = 0.5
		lootPos[] = {{-0.5,-0.1992,-1.81428},{1.08008,0.300781,-1.81428}};
		};
		
		class Land_Bet_RGB_667_b : Military {
		maxRoaming = 3;
		lootChance = 0.5
		lootPos[] = {{-0.5,-0.1992,-1.81428},{1.08008,0.300781,-1.81428}};
		};
		
		class Land_Bet_RGB_667_b_a : Military {
		maxRoaming = 3;
		lootChance = 0.5
		lootPos[] = {{-0.5,-0.1992,-1.81428},{1.08008,0.300781,-1.81428}};
		};
		
		class Land_Bet_RGB669_pak_L : Military {
		maxRoaming = 3;
		lootChance = 0.5
		lootPos[] = {{0.210327,0.71582,-0.489454},{-0.98175,0.519531,-0.489452}};
		};
		
		class Land_Bet_RGB669_pak_r : Military {
		maxRoaming = 3;
		lootChance = 0.5
		lootPos[] = {{0.210327,0.71582,-0.489454},{-0.98175,0.519531,-0.489452}};
		};
		
		class Land_Bet_RGB669_pak_L_splinter : Military {
		maxRoaming = 3;
		lootChance = 0.5
		lootPos[] = {{0.210327,0.71582,-0.489454},{-0.98175,0.519531,-0.489452}};
		};
		
		class Land_Bet_RGB669_pak_r_splinter : Military {
		maxRoaming = 3;
		lootChance = 0.5
		lootPos[] = {{0.210327,0.71582,-0.489454},{-0.98175,0.519531,-0.489452}};
		};
		
		class Land_Bet_RGB_671 : Military {
		maxRoaming = 3;
		lootChance = 0.5
		lootPos[] = {{4.90717,-2.32715,-2.12382},{0.667603,-3.06641,-2.12382},{2.7478,-2.78516,3.11271}};
		};
		
		
		class Land_bet_unterstand_b : Military {
		maxRoaming = 3;
		lootChance = 0.5
		lootPos[] = {{3.46295,-0.803711,-0.484062},{4.06714,0.168945,-0.484062}};
		};
		
				class Land_bet_unterstand_art_b : Military {
		maxRoaming = 3;
		lootChance = 0.5
		lootPos[] = {{3.46295,-0.803711,-0.484062},{4.06714,0.168945,-0.484062}};
		};
		
				class Land_bet_unterstand_art : Military {
		maxRoaming = 3;
		lootChance = 0.5
		lootPos[] = {{3.46295,-0.803711,-0.484062},{4.06714,0.168945,-0.484062}};
		};
		
				class Land_Bet_Regelbau10 : Military {
		maxRoaming = 0;
		lootPos[] = {{4.71973,4.41724,-0.231161},{-1.21777,2.00146,-0.231161},{-5.07617,-0.864746,-0.231161}};
		};
		
				class Land_Bet_regelbau_d2 : Military {
		maxRoaming = 0;
		lootChance = 0.9
		lootPos[] = {{-1.96191,1.08887,-0.193186},{2.02051,1.28125,-0.193184}};
		};
				class Land_Bet_regelbau_d2_a : Military {
		maxRoaming = 0;
		lootChance = 0.9
		lootPos[] = {{-1.96191,1.08887,-0.193186},{2.02051,1.28125,-0.193184}};
		};
		
		class Land_Bet_regelbau_d2_b : Military {
		maxRoaming = 0;
		lootChance = 0.9
		lootPos[] = {{-1.96191,1.08887,-0.193186},{2.02051,1.28125,-0.193184}};
		};
	...
	{
		lootPos[] = {{-3.17432,-0.135986,-1.10776},{-3.00684,-3.99243,0.823997},{5.61035,-4.22314,0.822979},{6.02295,-1.42456,0.822979},{-5.04639,-2.927,3.80019},{-3.20361,1.33789,3.80019}};
	};
	class land_dum_istan4 : Residential
	{
		lootPos[] = {{2.71582,-2.70264,-4.34237},{2.88232,-7.89893,-5.9352},{-5.61206,6.37793,-7.29237},{-0.380859,6.31396,-7.29237},{5.2793,6.20996,-7.29237}};
	};
	class land_dum_istan3 : Residential
	{
		lootPos[] = {{-9.53223,-4.1228,-0.808691},{4.37793,-4.88525,0.585144},{3.06836,-1.87598,0.570742},{-6.05371,-1.89746,0.585144},{-10.3887,-4.39233,-1.10769}};
	};
	class Land_Barrack2 : Military
	{
		lootPos[] = {{-0.825195,4.63232,-0.689318},{-0.855469,-0.276855,-0.692207}};
	};
	class Land_fortified_nest_small : Residential
	{
		lootPos[] = {{-0.0678711,-0.342285,-0.767475}};
	};
	class Land_vez : Military
	{
		lootPos[] = {{0.00585938,1.58325,1.36331}};
	};
	class land_stan_east : Military
	{
		lootPos[] = {{0.359863,-0.17627,-1.31049}};
	};
	class land_mash : Hospital
	{
		lootPos[] = {{0.554199,-1.10449,-1.17806}};
	};
	class Land_water_tank : Residential
	{
		lootPos[] = {{2.70361,32.2563,-1.20788}};
	};

	class land_house_y : Residential
	{
		lootPos[] = {{-0.584473,5.46704,-1.40696},{3.97852,5.48413,-1.40696}};
	};
	class Land_dum_olez_istan2 : Residential
	{
		lootPos[] = {{4.6543,0.0615234,-0.969959}};
	};
		
		class Land_Bet_haus_2_bs_b: Residential {
		zombieChance = 0.6;
		minRoaming = 1;
		maxRoaming = 3;
		zombieClass[] = {"zZombie_Base","zZombie_Base","z_teacher","z_suit1","z_suit2"};
		lootChance = 0.6;
		lootPos[] = {{-2.67749,2.52002,-4.35001},{1.27749,2.52002,-4.35001},{1.97749,2.52002,-4.35001}}; 
		};// Qty: 1
		
		class Land_Bet_haus_2_fw_a: Residential {
		zombieChance = 1;
		minRoaming = 1;
		maxRoaming = 3;
		zombieClass[] = {"zZombie_Base","zZombie_Base","z_teacher","z_suit1","z_suit2"};
		...
		class Land_Bet_haus_2_fw_b: Residential {
		zombieChance = 1;
		minRoaming = 1;
		maxRoaming = 3;
		zombieClass[] = {"zZombie_Base","zZombie_Base","z_teacher","z_suit1","z_suit2"};
		...
		class Land_Bet_haus_2_fw_c: Residential {
		zombieChance = 0.6;
		minRoaming = 1;
		maxRoaming = 3;
		zombieClass[] = {"zZombie_Base","zZombie_Base","z_teacher","z_suit1","z_suit2"};
		...
		class Land_Bet_haus_2_fw_d: Residential {
		zombieChance = 0.6;
		minRoaming = 1;
		maxRoaming = 3;
		zombieClass[] = {"zZombie_Base","zZombie_Base","z_teacher","z_suit1","z_suit2"};
		...
		class Land_Bet_haus_3_fw_a: Residential {
		zombieChance = 1;
		minRoaming = 1;
		maxRoaming = 3;
		zombieClass[] = {"zZombie_Base","zZombie_Base","z_teacher","z_suit1","z_suit2"};
		lootChance = 0.6;
		lootPos[] = {{2.81152,3.61426,-2.7266},{-1.82178,3.10547,-2.7266},{0.487793,3.38867,-2.7266}};
		};// Qty: 1
		
		class Land_Bet_haus_4_bs_a: Residential {
		zombieChance = 1;
		minRoaming = 1;
		maxRoaming = 3;
		zombieClass[] = {"zZombie_Base","zZombie_Base","z_teacher","z_suit1","z_suit2"};
		lootChance = 0.6;
		lootPos[] = {{2.81152,2.80547,-1.17266},{-1.82178,3.10547,-1.17266},{0.487793,3.38867,-1.17266}};
		};// Qty: 1
 ...
 class Land_A_Mosque_small_1_EP1: Residential
 {
  lootPos[] = {
 ...
 class Land_A_Mosque_small_2_EP1: Residential
 {
  lootPos[] = {
 ...
 class Land_A_Minaret_EP1: Residential
 {
  lootPos[] = {
 ...
 class Land_A_Minaret_Porto_EP1: Residential
 {
  lootPos[] = {
 ...
 class Land_A_Mosque_big_hq_EP1: Residential
 {
  lootPos[] = {
